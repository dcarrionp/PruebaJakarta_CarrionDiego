...
a persistence unit "PruebaJakarta_CarrionDiegoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PruebaJakarta_CarrionDiego/pom.xml":
...
artifact ("PruebaJakarta_CarrionDiego.war") is already built. You can build
